    ...
    <div className={`${styles.sidebar_menu} ${isOpen ? styles.open : ""}`}>
      ...
      <div className={styles.sidebar__wrapper}>
        <div className={styles.topBlock}>
          <div className={styles.topBlock__header}>
        ...
        <div className={styles.bottomBlock}>
          <div className={styles.bottomBlock__links}>
            <li>
              {userId ? (
                <NavLink to={`/user-page/${userId}`} onClick={handleClick}>
                  <span>
                    <Profile />
            ...
            <li>
              {userId ? (
                <NavLink to={`/liked/${userId}`} onClick={handleClick}>
                  <span>
                    <Liked /> Liked Cars
                  </span>
                </NavLink>
            ...
            <li>
              <span
              //  className={styles.currencySelected}
              >
                Currency
                <Select
          ...
          <hr />
          <div className={styles.bottomBlock__footer}>
            <Mobile color={"#1a1a1a"} number={"+79214003269"} />
            <Email color={"#1a1a1a"} email={"segas95@yandex.ru"} />
          </div>
        </div>
      </div>
    </div>
